...
{/* We've deprecated our legacy infrastructure, but you can still use it to [run your own instance](/docs/run-your-own) and plug it to [DocSearch v3](/docs/DocSearch-v3)! */}
